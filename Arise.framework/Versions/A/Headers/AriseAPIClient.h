...
extern NSString * const kAriseAPIVersion;

@interface AriseAPIClient : AriseAFHTTPClient {
    NSString *_appKey;
}

+ (AriseAPIClient *)sharedClientForKey:(NSString *)appKey rpcURL:(NSString *)rpcURL;
